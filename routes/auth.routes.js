...
router.post("/signup", (req, res, next) => {
  const { username, email, password, city, country, phoneNumber } = req.body;

  // Check if username or email or password are provided as empty strings
  if (
    username === "" ||
    email === "" ||
    password === "" ||
  ...
  User.findOne({ email })
    ...
    .then((createdUser) => {
      ...
      const { username, email, _id, city, country, phoneNumber } = createdUser;

      // Create a new object that doesn't expose the password
      const user = { username, email, _id, city, country, phoneNumber };
  ...
  User.findOne({ username })
    .then((foundUser) => {
      ...
      if (passwordCorrect) {
        ...
        const { _id, username, email, city, country, phoneNumber } = foundUser;
